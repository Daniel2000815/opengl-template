...
public:
	...
	inline vector<GLuint>   indices() const { return _indices; }
	inline vector<GLfloat>  colors() const { return _colors; }
	inline vector<GLfloat>  uv() const { return _texCoords; }
	...
	inline vec3             position() const { return _transform->position; }
	inline vec3             rotation() const { return _transform->rotation; }
	inline vec3             scale() const { return _transform->scale; }
